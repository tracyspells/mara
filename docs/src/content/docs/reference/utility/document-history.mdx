...
You must call this method in order to use [`document:undo()`](/reference/create-document/document/#undo) or [`document:redo()`](/reference/create-document/document/#redo)!

</Aside>

#### Parameters

- `document` - The [document](/reference/create-document/document) you want to track edits for
